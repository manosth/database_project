...
<html>
    ...
    <body>
        <p class="big-text">Queries:Average Drug Prices</p>
        <?php
            ...
            $sql = "SELECT Drug.Name, AVG(Sell.Price) AS Average
            FROM Sell, Drug
            ...
            echo "<center><table class='table'><tr><th colspan='2' style='background-color:#3c9f40'><center>Average Drug Prices</center></th></tr><tr><th>Drug</th><th>Average Price</th></tr>";
