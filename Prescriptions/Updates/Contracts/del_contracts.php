    ...
    <body>
        <?php
            if (isset($_POST['submit'])) {
                ...
                $sql = "DELETE FROM Contract WHERE PharmacyId =" . substr($todelete, 0, 1) . " AND PharmaceuticalCompanyId =" . substr($todelete, 1, 1);
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
            ...
            <?php
                ...
                $result = $conn->query($sql);
                $option = "<select class='selectpicker' name='contract'>";
